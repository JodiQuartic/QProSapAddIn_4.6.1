...
{
    internal class SapConfigModule : Module
    {
        private static SapConfigModule _this = null;
        ...
        public static SapConfigModule Current
        {
            get
            {
                return _this ?? (_this = (SapConfigModule)FrameworkApplication.FindModule("SapConfigModule"));
            }
        }
        ...
        //    else
        //    {
        //        //Msgbox("There are no Data Service Names Setup on this machine. You must first setup valid connections to Sap in Microsoft ODBC Administrator. ");
        //    }
        ...
        private List<string> _saptables = new List<string>();
        internal List<string> SapTables
        {
        ...
        {
            if (pane.ContentID == "QProSapAddIn_TableViewerPanel")
            { }
        }
